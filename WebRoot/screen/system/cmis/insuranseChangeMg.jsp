...
<div id="divDialog" class="divDialog">
    ...
    <div style="overflow-x:auto;overflow-y:hidden;">
        ...
        <div class="table_nav" style="display:inline">
            ...
            <a href="javaScript:void(0)" id="export" onclick="exportData()">社保变动导出</a>
        ...
        <table id="iwapGrid"
            ...
            <tr>
                <th data-grid-name="B_ID" primary="primary" data-order="">
                    <s><input type="checkbox" selectmulti="selectmulti" value="{{value}}"></s></th>
                <th data-grid-name="I_CMIS" class="tab_css_1">员工号</th>
                <th data-grid-name="I_NAME" class="tab_css_1">姓名</th>
                <th data-grid-name="I_SOCIAL_SECURITY" class="tab_css_1">社保号</th>
                <th data-grid-name="I_PUBILC_FUNDS" class="tab_css_1">公积金账号</th>
                <th data-grid-name="I_OLDBXWEGAS" class="tab_css_1">养老保险缴费基数</th>
                <th data-grid-name="I_YLBXWEGAS" class="tab_css_1">医疗保险缴费基数</th>
                <th data-grid-name="I_SYBXWEGAS" class="tab_css_1">失业保险缴费基数</th>
                <th data-grid-name="I_GSBXWEGAS" class="tab_css_1">工伤保险基数</th>
                <th data-grid-name="I_SYUBXWEGAS" class="tab_css_1">生育保险基数</th>
                <th data-grid-name="I_QNWEGAS" class="tab_css_1">企业年金基数</th>
                <th data-grid-name="I_GZJWEGAS" class="tab_css_1">公积金缴费基数</th>
                <th data-grid-name="I_BGZJWEGAS" class="tab_css_1">补充公积金缴费基数</th>
                <th data-grid-name="I_ZFBTWEGAS" class="tab_css_1">住房补贴基数</th>
                <th data-grid-name="I_TIMES" class="tab_css_1">变动时间</th>
                <th data-grid-name="I_REMARK" class="tab_css_1">备注</th>
                <th data-grid-name="I_STATUS" class="tab_css_1">执行状态</th>
                <th data-grid-name="I_IDCARD" class="tab_css_1">身份证号</th>
                <th data-grid-name="I_SENDDEPT" class="tab_css_1">发薪机构</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*查询表格初始化  设置默认查询条件*/
        var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'insuranseChangeMg'};
    ...
    function exportData(){
        var data = {'exportFlag':'1','filetype':'xlsx','option':"export",'txcode':'insuranseChangeMg','holidayids': iwapGrid.getCheckValues(),'actionId':'doBiz','start':'0','limit':'1000'};
