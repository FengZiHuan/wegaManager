...
<body class="iwapui center_body">
	...
	<form id="Conditions" class="clearfix">
		...
		<div class="col-md-6 fl">
			<div class="inputbox tl pr" data-iwap="tooltipdiv"
				data-iwap-empty="true">
				<span>居住城市:</span><input name="liveCity" type="text"
					data-iwap-xtype="TextField" id="liveCity" class="input_text"
					value="">
			</div>
		</div>
		...
		<div class="col-md-6 fl">
			<div class="inputbox tl pr" data-iwap="tooltipdiv"
				data-iwap-empty="true">
				<span>工作城市:</span><input name="workCity" type="text"
					data-iwap-xtype="TextField" id="workCity" class="input_text"
					value="">
			</div>
		</div>
		<div class="col-md-6 fl">
		<div class="selectbox mr60 inputbox">
				<label class="select_label">交流补贴:</label> 
				<select data-iwap-xtype="ListField" name="state" class="select_content" id="state">
	...
	<div class="table_box">
		...
		<table id="iwapGrid"
			...
			<tr>
				...
				<th data-grid-name="LIVE_CITY" class="tl">居住城市</th>
				<th data-grid-name="WORK_CITY" class="tl">工作城市</th>
				<th data-grid-name="DISTANCE" class="tl">路程距离</th>
				<th data-grid-name="SUBSIDY_AMOUNT" class="tl">交流补贴标准</th>
				<th data-grid-name="BEGIN_DATE" class="tl">开始时间</th>
				<th data-grid-name="END_DATE" class="tl">结束时间</th>
				<th data-grid-name="ROLE_ID" option="option" option-html=''><span>操作</span>
					<s>
					    ...
					    <a href="javaScript:void(0)" class="editId" onclick="exportOneData(this)">导出</a>
					</s>
				</th>
			</tr>
		</table>
...
$(document).ready(function() {
			...
			/*查询表格初始化  设置默认查询条件*/
			var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'exchangesubsidy'};
