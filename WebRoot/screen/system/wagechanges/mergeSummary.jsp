...
<body class="iwapui center_body">
	...
	<input type="hidden" value="${qureyparams.countMonth}" id="countMonth">
	<input type="hidden" value="${qureyparams.branchName}" id="bankName">
	<!-- 对话框开始 -->
	...
	<div style="overflow: auto; width: 100%;">
		...
		<table id="iwapGrid"
			...
			<tr>
				...
				<th data-grid-name="GSBX_PERSONAL_MONTHPAY" class="tl">工伤保险个人月缴费金额</th>				
				<th data-grid-name="SYUBX_COMPANY_MONTHPAY" class="tl">生育保险单位月缴费金额</th>
				<th data-grid-name="SYUBX_PERSONAL_MONTHPAY" class="tl">生育保险个人月缴费金额</th>
...
$(document).ready(function() {
			...
			debugger;
			var month="${qureyparams.payMonth}";
			$("#payMonth").val(month);
			...
			/*查询表格初始化  设置默认查询条件*/
			var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'mergeSummary','option':'queryInfo'};
...
function doSave(){
	...
	var extParam={'option':actionType,'txcode':'mergeSummary','actionId':'doBiz'};
...
function submission(){
	...
	var param={'option':"submission",'txcode':"mergeSummary",'userids': iwapGrid.getCheckValues(),'actionId':"doBiz"};
	$.IWAP.iwapRequest("iwap.ctrl",param,function(rs){
		 if (rs['header']['msg']) {
...
//返回
function comeBack(){
	window.location="${ctx}/iwap.ctrl?txcode=mergeSummary";
}
</script>
</html>