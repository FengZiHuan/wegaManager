...
<body class="iwapui center_body">
	...
	<!-- 查询内容区域　开始 -->
		...
		<div class="table_nav" style="display:inline">
            ...
            <a href="javaScript:void(0)" id="export" onclick="exportData()">人员变动导出导出</a>
        ...
        <table id="iwapGrid"
            ...
            <tr>
                <th data-grid-name="G_ID" primary="primary" data-order=""><input
                        type="checkbox" name="selectname" selectmulti="selectmulti"
                        value=""> <s><input type="checkbox"
                                            selectmulti="selectmulti" value="{{value}}"></s></th>
                <th data-grid-name="G_NAME" class="tl">姓名</th>
                <th data-grid-name="G_FMIS" class="tl">员工号</th>
                <th data-grid-name="G_REASON" class="tl">加班原因</th>
                <th data-grid-name="G_TIMES" class="tl">具体加班时间</th>
                <th data-grid-name="G_THDAYS" class="tl">天数（3倍工资）</th>
                <th data-grid-name="G_DODAYS" class="tl">天数（2倍工资）</th>
                <th data-grid-name="G_GZ" class="tl">基本工资</th>
                <th data-grid-name="G_OVERGZ" class="tl">计算加班工资的基数工资（元）</th>
                <th data-grid-name="G_SDAYGZ" class="tl">加班工资（元）</th>
                <th data-grid-name="G_ZSGZ" class="tl">值班费(元）</th>
                <th data-grid-name="G_SGZ" class="tl">合计</th>
                <th data-grid-name="G_ID" option="option" option-html=''><span>操作</span>
                    <s>
...
$(document).ready(function() {
			...
			/*查询表格初始化  设置默认查询条件*/
			var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'overtimeSummaryMg'};
...
function exportData(){
    ...
    var data = {'exportFlag':'1','year':year,'y':y,'filetype':'xlsx','option':"export",'txcode':'overtimeSummaryMg','holidayids': iwapGrid.getCheckValues(),'actionId':'doBiz','start':'0','limit':'1000'};
