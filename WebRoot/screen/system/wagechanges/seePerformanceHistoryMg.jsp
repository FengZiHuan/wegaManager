...
<div id="divDialog" class="divDialog">
    ...
    <form id="Conditions" class="clearfix">
        ...
        <div class="col-md-6 fl">
            <div class="inputbox tl pr" data-iwap="tooltipdiv"
                 data-iwap-empty="true">
                <span>分行:</span><input name="brand" type="text"
                                         data-iwap-xtype="TextField" id="brand" class="input_text"
                                         value="">
            </div>
        </div>
        <div class="col-md-6 fl">
        ...
        <div class="col-md-6">
            <div class="inputbox pr" data-iwap="tooltipdiv"
                ...
                <span>发放年月:</span> <input data-iwap-xtype="TextField" id="time" name="time" class="Wdate"
    ...
    <div class="table_box">
        ...
        <table id="iwapGrid"
            ...
            <tr>
                <th data-grid-name="RC_ID" primary="primary" data-order=""><input
                        type="checkbox" name="selectname" selectmulti="selectmulti"
                        value=""> <s><input type="checkbox"
                                            selectmulti="selectmulti" value="{{value}}"></s></th>
                <th data-grid-name="RC_BRAND" class="tl">分行</th>
                <th data-grid-name="RC_NAME" class="tl">姓名</th>
                <th data-grid-name="RC_FMIS" class="tl">fmis</th>
                <th data-grid-name="RC_TIMES" class="tl">发放时间</th>
                <th data-grid-name="RC_MONEY" class="tl">发放金额</th>
                <th data-grid-name="RC_YEAR" class="tl">分行上传年份</th>
                <th data-grid-name="RC_ID" option="option" option-html=''><span>操作</span>
                    <s>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*查询表格初始化  设置默认查询条件*/
        var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'seePerformanceHistoryMg'};
