            ...
            <s>
                ...
                <th data-grid-name="CHECK_NO" option="option" option-html='' class="tab_css_1">
                    ...
                    <s>
                        ...
                        <a href="javaScript:void(0)" class="editId" onclick="delOne(this)">附件</a>
                    </s>
                </th>
            </s>
        </tr>
...
<script type="text/javascript">
    ...
    //保存
    function doSave() {
        var extParam = {'option': actionType, 'txcode': 'readerCheckMg', 'actionId': 'doBiz'};
    ...
    function exportData(){
        ...
        var data = {'exportFlag':'1','filetype':'xlsx','option':"export",'txcode':'readerCheckMg', 'checkNo': iwapGrid.getCurrentRow()['CHECK_NO'],'actionId':'doBiz','start':'0','limit':'1000'};
