...
<div style="overflow: auto; width: 100%;">
    ...
    <!-- 表格工具栏　END -->
    <table id="iwapGrid" class="tab_css_1"
           data-iwap="grid" data-iwap-id="" data-iwap-param=""
           data-iwap-pagination="true">
        <tr>
            <th data-grid-name="JX_ID" primary="primary" data-order=""><s><input type="checkbox"
            ...
            <th data-grid-name="JX_HZ1" class="tl">行长</th>
            <th data-grid-name="JX_FHZ1" class="tl">副行长</th>
            <th data-grid-name="JX_SUM1" class="tl">合计</th>
            <th data-grid-name="JX_NAME2" class="tl">项目</th>
            <th data-grid-name="JX_HZ2" class="tl">行长</th>
            <th data-grid-name="JX_FHZ2" class="tl">副行长</th>
            <th data-grid-name="JX_SUM2" class="tl">合计</th>
            <th data-grid-name="JX_NAME3" class="tl">项目</th>
            <th data-grid-name="JX_HZ3" class="tl">行长</th>
            <th data-grid-name="JX_FHZ3" class="tl">副行长</th>
            <th data-grid-name="JX_SUM3" class="tl">合计</th>
            <th data-grid-name="JX_NAME4" class="tl">项目</th>
            <th data-grid-name="JX_HZ4" class="tl">行长</th>
            <th data-grid-name="JX_FHZ4" class="tl">副行长</th>
            <th data-grid-name="JX_SUM4" class="tl">合计</th>
            <th data-grid-name="JX_NAME5" class="tl">项目</th>
            <th data-grid-name="JX_HZ5" class="tl">行长</th>
            <th data-grid-name="JX_FHZ5" class="tl">副行长</th>
            <th data-grid-name="JX_SUM5" class="tl">合计</th>
            <th data-grid-name="JX_NAME6" class="tl">项目</th>
            <th data-grid-name="JX_HZ6" class="tl">行长</th>
            <th data-grid-name="JX_FHZ6" class="tl">副行长</th>
...
<script type="text/javascript">
    ...
    fileUpload = $.IWAP.FileUpload({
        ...
        'afterUpload':function(){
            var field={'imp_id':'0000015','files':fileUpload.getFileName(),'isOverWrite':'true'};
