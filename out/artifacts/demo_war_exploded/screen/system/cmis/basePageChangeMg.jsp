...
<div id="divDialog" class="divDialog">
    ...
    <form id="Conditions" class="clearfix">
        ...
        <div class="col-md-6 fl">
            <div class="inputbox tl pr" data-iwap="tooltipdiv"
                 data-iwap-empty="true">
                <span>员工号:</span><input name="fmis" type="text"
    ...
    <div style="overflow-x:auto;overflow-y:hidden;">
        ...
        <div class="table_nav" style="display:inline">
            ...
            <a href="javaScript:void(0)" id="export" onclick="exportData()">基本工资变动导出</a>
        ...
        <table id="iwapGrid"
            ...
            <tr>
                ...
                <th data-grid-name="B_CMIS" class="tab_css_1">员工号</th>
                <th data-grid-name="B_NAME" class="tab_css_1">姓名</th>
                <th data-grid-name="B_POST" class="tab_css_1">行政职务</th>
                <th data-grid-name="B_POSTTYPE" class="tab_css_1">行政职级</th>
                <th data-grid-name="B_POSTTIMES" class="tab_css_1">行政职务（职级）聘任时间</th>
                <th data-grid-name="B_TP" class="tab_css_1">专业技术职务</th>
                <th data-grid-name="B_TPTIMES" class="tab_css_1">专业技术职务聘任时间</th>
                <th data-grid-name="B_TGW" class="tab_css_1">工人技术等级</th>
                <th data-grid-name="B_TGWTIMES" class="tab_css_1">工人技术等级聘任时间</th>
                <th data-grid-name="B_EDU" class="tab_css_1">最高学历</th>
                <th data-grid-name="B_EDUTIMES" class="tab_css_1">最高学历取得时间</th>
                <th data-grid-name="B_WORKYEAR" class="tab_css_1">工龄</th>
                <th data-grid-name="B_WD" class="tab_css_1">营业网点员工</th>
                <th data-grid-name="B_HARD" class="tab_css_1">艰边津贴</th>
                <th data-grid-name="B_SPE" class="tab_css_1">西藏特殊津贴</th>
                <th data-grid-name="B_TIMES" class="tab_css_1">变动时间</th>
                <th data-grid-name="B_REASON" class="tab_css_1">变动原因</th>
                <th data-grid-name="B_REMARK" class="tab_css_1">备注</th>
                <th data-grid-name="B_STATUS" class="tab_css_1">执行状态</th>
                <th data-grid-name="B_IDCARD" class="tab_css_1">身份证号</th>
                <th data-grid-name="B_SENDDEPT" class="tab_css_1">发薪机构</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*查询表格初始化  设置默认查询条件*/
        var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'basePageChangeMg'};
