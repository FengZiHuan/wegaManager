...
<div id="divDialog" class="divDialog">
    ...
    <div style="overflow-x:auto;overflow-y:hidden;">
        ...
        <div class="table_nav" style="display:inline">
            ...
            <a href="javaScript:void(0)" id="export" onclick="exportData()">岗位工资变动导出</a>
        ...
        <table id="iwapGrid"
            ...
            <tr>
                ...
                <th data-grid-name="P_POST" class="tl">发薪岗位</th>
                <th data-grid-name="P_POSTTIMES" class="tl">岗位聘任时间</th>
                <th data-grid-name="P_POSTTYPE" class="tl">岗位等级</th>
                <th data-grid-name="P_POSTS" class="tl">岗位族群</th>
                <th data-grid-name="P_WEGATYPE" class="tl">工资等级</th>
                <th data-grid-name="P_WEGAGRADE" class="tl">工资档次</th>
                <th data-grid-name="P_CHANGETIMES" class="tl">变动时间</th>
                <th data-grid-name="P_REASON" class="tl">变动原因</th>
                <th data-grid-name="P_REMARK" class="tl">备注</th>
                <th data-grid-name="P_STATUS" class="tl">执行状态</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*查询表格初始化  设置默认查询条件*/
        var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'postSalaryChangeMg'};
        ...
        fileUpload = $.IWAP.FileUpload({
            ...
            'afterUpload':function(){
                ...
                var data=JSON.stringify({'body':field,'header':{'txcode':"postSalaryChangeMg",'actionId':"doBiz"}});
                $.ajax({
                    timeout:0,
                    data:data,
                    cache:false,
    ...
    function exportData(){
        var data = {'exportFlag':'1','filetype':'xlsx','option':"export",'txcode':'postSalaryChangeMg','holidayids': iwapGrid.getCheckValues(),'actionId':'doBiz','start':'0','limit':'1000'};
