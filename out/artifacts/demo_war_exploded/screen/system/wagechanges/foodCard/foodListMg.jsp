...
<div id="divDialog" class="divDialog">
            ...
            <form method="post" onsubmit="return false" id="dialogarea">
                ...
                <div class="col-md-12">
                    ...
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                        ...
                        <span>项目1:</span> <input name="TEA_FREE" type="text"
                                                data-iwap-xtype="TextField" id="TEA_FREE" class="input_text"
                                                value=""  >
                    </div>
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                         data-iwap-empty="true" >
                        <span>项目2:</span> <input name="WASH_FREE" type="text"
                                                 data-iwap-xtype="TextField" id="WASH_FREE" class="input_text"
                                                 value="" >
                    </div>
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                         data-iwap-empty="true" >
                        <span>项目3:</span> <input name="FREE3" type="text"
                                                 data-iwap-xtype="TextField" id="FREE3" class="input_text"
                                                 value="" >
                    </div>
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                         data-iwap-empty="true" >
                        <span>项目4:</span> <input name="FREE4" type="text"
                                                 data-iwap-xtype="TextField" id="FREE4" class="input_text"
                                                 value="" >
                    </div>
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                         data-iwap-empty="true" >
                        <span>项目5:</span> <input name="FREE5" type="text"
                                                 data-iwap-xtype="TextField" id="FREE5" class="input_text"
                                                 value="" >
                    </div>
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                         data-iwap-empty="true" >
                        <span>项目6:</span> <input name="FREE6" type="text"
                                                 data-iwap-xtype="TextField" id="FREE6" class="input_text"
                                                 value="" >
                    </div>
                    <div class="inputbox pr" data-iwap="tooltipdiv"
                         data-iwap-empty="true" >
                        <span>项目7:</span> <input name="FREE7" type="text"
                                                 data-iwap-xtype="TextField" id="FREE7" class="input_text"
                                                 value="" >
                    </div>
    ...
    <form id="Conditions" class="clearfix">
        ...
        <div class="col-md-6 fl">
            <div class="inputbox pr" data-iwap="tooltipdiv"
                 data-iwap-empty="true">
                <span>选择批次:</span> <input data-iwap-xtype="TextField" id="batch" name="batch" class="Wdate"
...
<div class="table_nav" style="display:inline">
    <a id="exportByPeople" class="" onclick="exportByPeople()"
       href="javaScript:void(0)">充值名单导出</a>
</div>
<div class="table_nav" style="display:inline">
    <a id="exportByDept" class="" onclick="exportByDept()"
       href="javaScript:void(0)">充值汇总导出</a>
</div>
...
<table id="iwapGrid"
    ...
    <tr>
        ...
        <th data-grid-name="BATCH" class="tl">批次</th>
        <th data-grid-name="FMIS" class="tl">fmis号</th>
        <th data-grid-name="NAME" class="tl">姓名</th>
        <th data-grid-name="DEPT" class="tl">部门</th>
        <th data-grid-name="TEA_FREE" class="tl" id="a1"></th>
        <th data-grid-name="WASH_FREE" class="tl" id="a2"></th>
        <th data-grid-name="FREE3" class="tl" id="a3"></th>
        <th data-grid-name="FREE4" class="tl" id="a4"></th>
        <th data-grid-name="FREE5" class="tl" id="a5"></th>
        <th data-grid-name="FREE6" class="tl" id="a6"></th>
        <th data-grid-name="FREE7" class="tl" id="a7"></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*查询表格初始化  设置默认查询条件*/
        var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'foodListMg'};
        ...
        fileUpload = $.IWAP.FileUpload({
            ...
            'afterUpload':function(){
                var field={'imp_id':'000021','files':fileUpload.getFileName(),'isOverWrite':'false','option':'import','start':'1','limit':'10000'};
                var data=JSON.stringify({'body':field,'header':{'txcode':"foodListMg",'actionId':"doBiz"}});
                $.ajax({
                    timeout:0,
                    data:data,
                    cache:false,
    ...
    function doSave(){
        ...
        var extParam={'option':actionType,'txcode':'foodListMg','actionId':'doBiz','id':id};
    ...
    function del(){
        ...
        var param={'option':"remove",'txcode':"foodListMg",'userids': iwapGrid.getCheckValues(),'actionId':"doBiz"};
        $.IWAP.iwapRequest("iwap.ctrl",param,function(rs){
            if (rs['header']['msg']) {
    ...
    function delOne(obj){
        ...
        var param={'option':"remove",'txcode':"foodListMg",'userids': iwapGrid.getCurrentRow()['ID'],'actionId':"doBiz"};
        $.IWAP.iwapRequest("iwap.ctrl",param,function(rs){
            if (rs['header']['msg']) {
                return alert("删除失败:"+rs['header']['msg']);
            }else{
    ...
    function exportByPeople() {
        var batch=  $('#batch').val();
        if (batch=="") {
            if (!confirm("确定导出本期名单吗?请确定!"))
                return;
        }
        if (batch!="") {
            if (!confirm("确定选择往期名单吗?请确定!"))
                return;
        }
    ...
    function exportByDept(){
        var batch=  $('#batch').val();
        if (batch=="") {
            if (!confirm("确定导出本期汇总吗?请确定!"))
                return;
        }
        if (batch!="") {
            if (!confirm("确定选择往期汇总吗?请确定!"))
                return;
        }
