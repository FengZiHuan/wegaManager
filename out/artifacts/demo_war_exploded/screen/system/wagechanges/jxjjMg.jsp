...
<div style="overflow: auto; width: 100%;">
    ...
    <table id="iwapGrid" class="tab_css_1"
        ...
        <tr class="tr_css">
            <s>
            <th data-grid-name="JX_ID" primary="primary" data-order="">
                <s><input type="checkbox" selectmulti="selectmulti" value="{{value}}"></s></th>
                <th data-grid-name="JX_DEPT" class="tab_css_1">部门</th>
                <th data-grid-name="JX_FMIS" class="tab_css_1">FMIS员工号</th>
                <th data-grid-name="JX_NAME" class="tab_css_1">姓名</th>
                <th data-grid-name="JX_GW" class="tab_css_1">岗位</th>
                <th data-grid-name="JX_XM" class="tab_css_1">项目</th>
                <th data-grid-name="JX_FJXGZ" class="tab_css_1">分配绩效工资</th>
                <th data-grid-name="JX_FJLGZ" class="tab_css_1">分配奖励工资</th>



            <th data-grid-name="JX_ID" option="option" option-html='' class="tab_css_1">
                <s>
