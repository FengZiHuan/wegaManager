...
public class TingFaMgAction extends TransactionBizAction {
    ...
    public int actionExecute(DTBHelper dtbHelper) throws BizActionException {
        ...
        if ("daochu2".equals(option)) {
            return daochu2(dtbHelper);
        }
        if ("daochu3".equals(option)) {
            return daochu3(dtbHelper);
        }
        return 0;
    }
    ...
    private int query(DTBHelper dtbHelper) throws BizActionException {
        ...
        try {
            ...
            String yue = dtbHelper.getStringValue("yue");
            String nh_zny = year + "-" + yue;

            DBAccessBean dbBean = DBAccessPool.getDbBean();
            PaginationSupport page = new PaginationSupport(start, limit, limit);
            List<Map<String, Object>> dataList = null;
            String sqlStr = null;
            if (year.equals("") && yue.equals("")) {
                //没输入年月不展示
                sqlStr = "select * from NH_HOLIDAY  where NH_BNXUTF>0  or NH_JNXUTF>0 or NH_GNXUTF>0  order by NH_NO";
            } else {
                String yuefen = "";
                if (yue.equals("1")) {
                ...
                if (year.equals("")) {
                    sqlStr = "select NH_NAME,NH_FMIS,NH_XIUJIAYEAR,NH_GYTF,NH_GYITF,NH_GNXUTF,NH_JYTF," +
                            "NH_JYITF,NH_JNXUTF, NH_BYTF, NH_BYTIF,NH_BNXUTF," + yuefen + ",NH_NTGZ,NH_NTJX,NH_NTCHE,NH_YTGZ,NH_YTJX,NH_YTCHE from NH_HOLIDAY" +
                            "where  NH_BNXUTF>0  or NH_JNXUTF>0 or NH_GNXUTF>0  order by NH_NO";
                } else {

                    sqlStr = "select * from NH_HOLIDAY where NH_XIUJIAYEAR='" + year + " 'AND NH_BNXUTF>0  or NH_JNXUTF>0 or NH_GNXUTF>0  order by NH_NO";
    ...
    protected int daochu(DTBHelper dtbHelper) {
        ...
        String yue = (a + 1) + "";
        if (dtbHelper.getStringValue("year") != "") {
            year = dtbHelper.getStringValue("year");
        }
        if (dtbHelper.getStringValue("yue") != "") {
            yue = dtbHelper.getStringValue("yue");
        }
        int start = Integer.valueOf(dtbHelper.getStringValue("start"));
        int limit = Integer.valueOf(dtbHelper.getStringValue("limit"));
        ...
        try {
            ...
            if (userids.equals("")) {
                sql = "select NH_NO,NH_DEPT,NH_NAME,NH_FMIS,NH_QINGTYPE,NH_ZGWGZ,NH_ZJXGZ,NH_ZJTBT," +
                        "NH_DTGZ,NH_DTJX,NH_DTCHE,NH_DFGZ,NH_DFJX,NH_DFCHE,NH_BEIZHU,NH_FMIS,NH_ZNY from nh_holiday where NH_XIUJIAYEAR=?";
                ...
                for (String user : userarr) {
                    ...
                    List<Map<String, Object>> maps1 = dbBean.queryForList(sql, user,year);
...
//按年导出
    protected int daochu2(DTBHelper dtbHelper) {
        int flag = 0;
        DBAccessBean dbBean = null;
        String year=dtbHelper.getStringValue("year");
        ...
        try {
            ...
            if (userids.equals("")) {
                sql= "select NH_NO,NH_FMIS,NH_DEPT,NH_NAME,NH_ZGWGZ,NH_ZJXGZ,NH_ZJTBT,NH_QINGTYPE,NH_XIUJIAYEAR,NH_SUMDAYS,NH_TGWGZ,NH_TJXGZ,NH_TJTBTD,NH_GYTF,NH_GYITF,NH_GNXUTF,NH_JYTF, \n" +
                        ...
                        "NH_SIXTGZ,NH_SIXTJX,NH_SIXTCHE,NH_SETGZ,NH_SETJX,NH_SETCHE,NH_AGETGZ,NH_AGETJX,NH_AGETCHE,NH_NITGZ,\n" +
                        "NH_NITJX,NH_NITCHE,NH_TENTGZ,NH_TENTJX,NH_TENTCHE,NH_ETGZ,NH_ETJX,NH_ETCHE,NH_TTGZ,NH_TTJX,\n" +
                        "NH_TTCHE,NH_NTGZ,NH_NTJX,NH_NTCHE,NH_YTGZ,NH_YTJX,NH_YTCHE from nh_holiday where NH_XIUJIAYEAR=? ";
                dataList = dbBean.queryForList(sql,year);
                dataList.size();
                ...
                for (String user : userarr) {
                    ...
                    List<Map<String, Object>> maps = dbBean.queryForList(sql, year,user);
                    for (Map<String, Object> map : maps) {
                        dataList.add(map);
                    }
                }
    ...
    protected int daochu3(DTBHelper dtbHelper) {
        int flag = 0;
        DBAccessBean dbBean = null;
        ...
        try {
            ...
            if (userids.equals("")) {
                sql= "select NH_NO,NH_FMIS,NH_DEPT,NH_NAME,NH_ZGWGZ,NH_ZJXGZ,NH_ZJTBT,NH_QINGTYPE,NH_XIUJIAYEAR,NH_SUMDAYS,NH_TGWGZ,NH_TJXGZ,NH_TJTBTD,NH_GYTF,NH_GYITF,NH_GNXUTF,NH_JYTF, \n" +
                        ...
                        "NH_SIXTGZ,NH_SIXTJX,NH_SIXTCHE,NH_SETGZ,NH_SETJX,NH_SETCHE,NH_AGETGZ,NH_AGETJX,NH_AGETCHE,NH_NITGZ,\n" +
                        "NH_NITJX,NH_NITCHE,NH_TENTGZ,NH_TENTJX,NH_TENTCHE,NH_ETGZ,NH_ETJX,NH_ETCHE,NH_TTGZ,NH_TTJX,\n" +
                        "NH_TTCHE,NH_NTGZ,NH_NTJX,NH_NTCHE,NH_YTGZ,NH_YTJX,NH_YTCHE from nh_holiday where NH_NAME like ? ";
                ...
                for (String user : userarr) {
                    ...
                    List<Map<String, Object>> maps = dbBean.queryForList(sql, name,user);
                    for (Map<String, Object> map : maps) {
                        dataList.add(map);
                    }
                }
